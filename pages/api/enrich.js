...
Use current, accurate information. If you can't confidently identify the drink, make a reasonable best guess rather than leaving fields null. If you cannot find a real rating, set rating, ratingScale, ratingSource, and ratingLink to null — never invent one. Only set imageUrl to a URL you are confident is a real, direct image link — never invent or guess one.`;
      ...
      try {
        ...
        if (imgRes.ok) {
          ...
          if (contentType.startsWith("image/")) {
            ...
            json.photoUrl = blob.url;
          }
        }
      } catch {
        // couldn't fetch/re-host the image — leave photoUrl unset, form still works without a photo
      }
